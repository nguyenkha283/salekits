...
export type Role = 'Trưởng line' | 'APM' | 'Trợ lý dự án' | 'Hành chính dự án' | 'Quản lý giao dịch' | 'Trưởng phòng QLGD' | 'Marketing' | 'Trưởng phòng Marketing' | 'Ban lãnh đạo' | 'User khác';
const ROLES: Role[] = ['Trưởng line', 'APM', 'Trợ lý dự án', 'Hành chính dự án', 'Quản lý giao dịch', 'Trưởng phòng QLGD', 'Marketing', 'Trưởng phòng Marketing', 'Ban lãnh đạo', 'User khác'];
